...
function canvas() {
    ...
    let w = (canvasElem.width = window.innerWidth);
    let h = (canvasElem.height = window.innerHeight);
    ...
    window.addEventListener("resize", function () {
        w = canvasElem.width = window.innerWidth;
        h = canvasElem.height = window.innerHeight;
        ctx.fillStyle = "#000";
        ctx.fillRect(0, 0, w, h);
